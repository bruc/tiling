...
d_path=$(readlink -f ../data/2022-ssAAV-scAAV-mix/0-reads)
...
fa_s=($(readlink -f ../references/mixed.fasta))
...
tiling_d="../tiling/2022-ssAAV-scAAV-mix"
if [[ ! -d $tiling_d ]]
then
...
do
    fa=${d_path}/m64012_220203_214130.hifi_reads.fasta
    if [[ ! -r $fa ]]
    then
